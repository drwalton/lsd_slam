...
public:
	...
	Sim3TrackerOmni(int w, int h, Eigen::Matrix3f K);
	Sim3TrackerOmni(const Sim3TrackerOmni&) = delete;
	Sim3TrackerOmni& operator=(const Sim3TrackerOmni&) = delete;
	~Sim3TrackerOmni();
