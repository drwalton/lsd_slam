...
Sim3TrackerOmni::Sim3TrackerOmni(int w, int h, Eigen::Matrix3f K)
{
	width = w;
	height = h;
...
Sim3TrackerOmni::~Sim3TrackerOmni()
{
...
Sim3 Sim3TrackerOmni::trackFrameSim3(
...
void Sim3TrackerOmni::calcSim3Buffers(
...
Sim3ResidualStruct Sim3TrackerOmni::calcSim3WeightsAndResidual(
		const Sim3& referenceToFrame)
{
...
void Sim3TrackerOmni::calcSim3LGS(LGS7 &ls7)
{
	LGS4 ls4;
	LGS6 ls6;
...
void Sim3TrackerOmni::calcResidualAndBuffers_debugStart()
{
...
void Sim3TrackerOmni::calcResidualAndBuffers_debugFinish(int w)
{
