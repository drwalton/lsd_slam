...
public:
	...
	std::unordered_multimap< const Frame*, Sim3, std::hash<const Frame*>, std::equal_to<const Frame*>,
		Eigen::aligned_allocator< std::pair<const Frame* const,Sim3> > > trackingFailed;
